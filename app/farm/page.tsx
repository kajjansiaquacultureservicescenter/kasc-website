...
export const metadata: Metadata = {
  title: "Our Farm",
  description: "Visit the Kajjansi Aquaculture Service Centre demonstration farm — hatchery, training centre, demo ponds, water lab, and fabrication shop, all at Kajjansi, Wakiso, Uganda.",
};
...
const FACILITIES = [
  ...
  { icon: GraduationCap, title: "Training & Conference Centre", desc: "A dedicated hands-on training facility where we run aquaculture courses, dam liner installation programs, and farmer workshops." },
    ...
    <div className="overflow-x-hidden">
      ...
      <section className="relative py-24 lg:py-32 overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#0c4a6e]/90 via-[#075985]/80 to-[#0c4a6e]/60" />
        </div>
        ...
        <div className="container-wide relative z-10">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 text-blue-100 text-sm mb-6">
              <MapPin size={14} className="text-[#7dd3fc]" /> Kajjansi, Wakiso, Uganda
            </div>
        ...
        <div className="container-wide">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center mb-16">
            <div>
              ...
              <h2 className="text-3xl font-bold text-[#0c4a6e] mb-5 leading-tight">
                More Than a Farm —{" "}
                <span className="text-gradient">A Centre of Excellence</span>
              </h2>
              <p className="text-gray-600 leading-relaxed mb-4">
                The Kajjansi Aquaculture Service Centre farm is our living laboratory and training ground. Everything we recommend to our clients, we first test and perfect here. From fingerling genetics to feed formulations to liner durability — we prove it at Kajjansi before we scale it.
              </p>
      ...
      <section className="section-padding gradient-section">
        <div className="container-wide">
          <div className="text-center max-w-xl mx-auto mb-12">
            <h2 className="text-3xl font-bold text-[#0c4a6e] mb-3">Farm Facilities</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {FACILITIES.map(({ icon: Icon, title, desc }) => (
              <div key={title} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-card-hover)] transition-shadow">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#0284c7] to-[#226640] flex items-center justify-center mb-4">
                  <Icon size={22} className="text-white" />
                </div>
                <h3 className="font-bold text-[#0c4a6e] mb-2 font-display">{title}</h3>
      ...
      <section className="section-padding bg-white">
        <div className="container-wide">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="text-3xl font-bold text-[#0c4a6e] mb-5">Visit Us</h2>
            ...
            <div className="rounded-2xl overflow-hidden shadow-xl border border-gray-100 h-80 lg:h-96 bg-gradient-to-br from-[#f0f9ff] to-[#f0fcf4] flex items-center justify-center">
              <iframe
                ...
                title="Kajjansi Aquaculture Service Centre location"
              />
            </div>
          </div>
        </div>

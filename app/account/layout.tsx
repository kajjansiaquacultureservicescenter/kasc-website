      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        <div className="mb-6">
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-4">
            <Link href="/" className="hover:text-[#0f5070]">Home</Link>
            <ChevronRight size={13} />
            <span className="text-[#0f5070] font-medium">My Account</span>
          </div>
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#0f5070] to-[#226640] flex items-center justify-center text-white font-bold">
              {name.slice(0, 2).toUpperCase()}
            </div>
            <div>
              <h1 className="text-xl font-bold text-[#071e2e] font-display">{name}</h1>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-3 shadow-sm space-y-1">
              {[
                ...
                <Link
                  key={href}
                  href={href}
                  className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-gray-600 hover:text-[#0f5070] hover:bg-[#eef8fd] transition-all"
                >
                  <Icon size={16} />
                  {label}
                </Link>
